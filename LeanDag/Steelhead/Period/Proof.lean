...
theorem holds : Statement := by
  ...
  · intro coin upd k₀ V per s j₁ r₁ b A hws hle hwa hid hI hreset hper hs hA hb hlead hgood hV
    exact output_liveness hws hle hwa hid hI hreset hper hs hA hb hlead hgood hV
