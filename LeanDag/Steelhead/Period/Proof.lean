...
theorem holds : Statement := by
  ...
  · intro coin upd k₀ V₁ V₂ out j k₁ k₂ hwa h₁ h₂
  ...
  · intro coin upd k₀ V out j k hp hall
    exact exists_periodAt_succ hp hall
  · intro coin upd k₀ V out c N hwa hI hrun hV j hN
  ...
  · intro coin upd k₀ V out j k h₀ hK hupd hp
    exact periodAt_mem_range h₀ hK hupd hp
  · intro upd
    exact failover_resets upd
