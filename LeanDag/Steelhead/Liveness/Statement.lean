...
the paper's asynchronous adversary (`steelhead.md` §4–6). Twelve claims:
...
SH6a, SH6b and SH6f assume `3 ≤ w r` everywhere, as the safety claims
do, and SH6f one slot per round; SH6c assumes nothing of the wave, and
