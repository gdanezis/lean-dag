...
LAYERS = [
    ...
    ("Steelhead: two rules at one wavelength function",
     ["Steelhead.Model.Wavelength", "Steelhead.Model.Decision",
      "Steelhead.Model.Chain", "Steelhead.Model.Period", "Steelhead.Model.Coin",
      "Steelhead.Model.Replay", "Steelhead.Model.Compose", "Steelhead.Model.Reactive",
      "Steelhead.Safety.Statement", "Steelhead.Liveness.Statement",
      "Steelhead.Period.Statement", "Steelhead.Coin.Statement",
      "Steelhead.Ledger.Statement", "Steelhead.Interface.Statement",
      "Steelhead.Broadcast.Statement", "Steelhead.Replay.Statement",
      "Steelhead.Helpers.Decision", "Steelhead.Helpers.Liveness",
      "Steelhead.Helpers.Period", "Steelhead.Helpers.Coin",
      "Steelhead.Helpers.Compose", "Steelhead.Helpers.Broadcast",
      "Steelhead.Helpers.Reactive", "Steelhead.Helpers.Replay",
      "Steelhead.Properties",
      "Steelhead.Safety.Proof", "Steelhead.Liveness.Proof",
      "Steelhead.Period.Proof", "Steelhead.Coin.Proof",
      "Steelhead.Ledger.Proof", "Steelhead.Interface.Proof",
      "Steelhead.Broadcast.Proof", "Steelhead.Replay.Proof"]),
