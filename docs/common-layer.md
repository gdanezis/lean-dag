...
**Progress.** Steps 1 to 4, 6, 8 and 9 landed as §11.31 to §11.36 and §11.38 of `docs/target-properties.md`; step 9 kept `Good` as a field and the two view laws, for the reasons §11.36 records.
